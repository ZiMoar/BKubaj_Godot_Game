...
@export var volley_projectile_scene: PackedScene = preload("res://src/entities/enemies/boss/boss_arrow.tscn")
@export var summon_enemy_scene: PackedScene = preload("res://src/entities/enemies/skeleton/skeleton_enemy.tscn")
